...
exports.ERROR_FIXES = void 0;
exports.fixFor = fixFor;
exports.fixVerdict = fixVerdict;
exports.ERROR_FIXES = [
    {
        fingerprint: "errorboundary::minified react error #310; visit <url> for the full message or use the non-minified dev environment for full errors and additional helpful warnings.",
        kind: "fixed",
 ...
 * exists to prevent.
 */
function fixVerdict(fix, lastSeen) {
    if (!fix)
        return "unclaimed";
...
//# sourceMappingURL=errorFixes.js.map