...
exports.linkVerdict = linkVerdict;
exports.verdictAdmits = verdictAdmits;
/**
 ...
 */
function linkVerdict(d, callerUid, now) {
    var _a, _b;
    ...
    if (callerUid && Array.isArray(d.redeemedBy) && d.redeemedBy.includes(callerUid))
        return 'already';
    if (callerUid && inviter === callerUid)
        return 'own';
    if (d.revoked === true)
        return 'revoked';
...
function verdictAdmits(v) {
    return v === 'ok' || v === 'already';
}
//# sourceMappingURL=inviteLinkState.js.map