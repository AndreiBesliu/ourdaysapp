...
exports.NOTIFY_STRINGS = exports.DEFAULT_LANG = exports.NOTIFY_LANGS = void 0;
exports.normaliseLang = normaliseLang;
exports.renderNotify = renderNotify;
exports.NOTIFY_LANGS = ['en-US', 'ro-RO', 'fr-FR', 'es-ES', 'it-IT', 'de-DE'];
exports.DEFAULT_LANG = 'en-US';
exports.NOTIFY_STRINGS = {
...
function normaliseLang(raw) {
    return exports.NOTIFY_LANGS.includes(String(raw))
        ? raw
 ...
 */
function renderNotify(key, lang, param) {
    var _a;
    const row = exports.NOTIFY_STRINGS[key];
    const base = row ? ((_a = row[lang]) !== null && _a !== void 0 ? _a : row[exports.DEFAULT_LANG]) : key;
    return param ? `${base}${param}` : base;
}
//# sourceMappingURL=notifyStrings.js.map