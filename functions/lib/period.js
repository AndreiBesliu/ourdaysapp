...
exports.dayRangePeriod = dayRangePeriod;
exports.periodDays = periodDays;
 ...
 */
function dayRangePeriod(fromDay, toDay) {
    if (!DAY.test(fromDay) || !DAY.test(toDay))
        return null;
    if (fromDay > toDay)
        return null;
