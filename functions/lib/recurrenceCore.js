...
function clampedDay(y, month0, d) {
 ...
 */
function seriesStartDay(dateIso) {
    ...
    return intoDay >= DAY_MS - 2 * 3600000 ? plusDays(utcDay, 1) : utcDay;
}
/** Occurrence `n` (0 is the start), computed from the START — never from occurrence n−1. */
function nthOccurrenceDay(startDay, freq, n) {
...
function horizonEndDay(startDay, freq) {
    const p = parts(startDay);
    if (!p)
        return null;
    const [y, m, d] = p;
...
//# sourceMappingURL=recurrenceCore.js.map