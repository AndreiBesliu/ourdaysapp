...
exports.mulberry32Once = mulberry32Once;
...
function nextRandom(state) {
    ...
    return { value, state: Object.assign(Object.assign({}, state), { rngCursor: state.rngCursor + 1 }) };
}
